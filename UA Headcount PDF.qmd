...
Employees who held employment with the university in a non-temporary status. Employee Classes include CR, EX, FR, F8, FN, NR, and XR.

#### Represented

Any employee who is covered by one of the following:
...
Any employee who identifies as "Female".

#### Person of Color

Any employee who indicated they considered themselves to be with at least one race other than "White".
